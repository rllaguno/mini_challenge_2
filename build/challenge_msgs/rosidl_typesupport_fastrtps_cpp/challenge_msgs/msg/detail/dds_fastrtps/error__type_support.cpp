...
#include "challenge_msgs/msg/detail/error__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = challenge_msgs::msg::Error;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const challenge_msgs::msg::Error *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<challenge_msgs::msg::Error *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_challenge_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<challenge_msgs::msg::Error>()
{
  return &challenge_msgs::msg::typesupport_fastrtps_cpp::_Error__handle;
}
