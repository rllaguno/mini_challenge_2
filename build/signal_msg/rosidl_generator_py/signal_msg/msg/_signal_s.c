...
bool signal_msg__msg__signal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("signal_msg.msg._signal.Signal", full_classname_dest, 29) == 0);
  }
  signal_msg__msg__Signal * ros_message = _ros_message;
  {  // name
...
PyObject * signal_msg__msg__signal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("signal_msg.msg._signal");
