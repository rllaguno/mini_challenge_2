...
static const _Signal_type_support_symbol_names_t _Signal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, signal_msg, msg, Signal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, signal_msg, msg, Signal)),
  }
};
...
{
  return &::signal_msg::msg::rosidl_typesupport_cpp::Signal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, signal_msg, msg, Signal)() {
  return get_message_type_support_handle<signal_msg::msg::Signal>();
}
