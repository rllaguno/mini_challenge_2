...
#include "signal_msg/msg/detail/signal__rosidl_typesupport_fastrtps_c.h"
...
using _Signal__ros_msg_type = signal_msg__msg__Signal;
  ...
  void * untyped_ros_message)
{
  ...
  _Signal__ros_msg_type * ros_message = static_cast<_Signal__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_signal_msg__msg__Signal(
  const void * untyped_ros_message,
...
static uint32_t _Signal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_signal_msg__msg__Signal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_signal_msg
size_t max_serialized_size_signal_msg__msg__Signal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = signal_msg__msg__Signal;
    is_plain =
      (
      offsetof(DataType, reliability) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Signal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_signal_msg__msg__Signal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, signal_msg, msg, Signal)() {
