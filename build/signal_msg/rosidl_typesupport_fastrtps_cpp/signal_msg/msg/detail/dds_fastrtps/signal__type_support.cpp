...
#include "signal_msg/msg/detail/signal__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = signal_msg::msg::Signal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const signal_msg::msg::Signal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<signal_msg::msg::Signal *>(
    untyped_ros_message);
...
static size_t _Signal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Signal(full_bounded, is_plain, 0);
...
{
  return &signal_msg::msg::typesupport_fastrtps_cpp::_Signal__handle;
}
