...
class Controller(Node) :
    ...
    def __init__(self) :
        ...
        self.get_logger().info('|Controller node successfully initialized yay90|')
    ...
    def timer_callback_controller(self) :
        ...
        if (self.banderaSignal):
            #left
            if (self.signal_num == 3 and (not self.banderaLeft) and (self.bandera)):
                try:
            ...
            #stop 
            if (self.signal_num == 7 and (not self.banderaStop) and (not self.bandera)):
                try:
